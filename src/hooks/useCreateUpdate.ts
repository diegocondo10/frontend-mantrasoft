...
import { BaseException } from '@src/services/service.exceptions';
...
const useCreateUpdate = <T>({
  ...
  const submitForm = async (data) => {
    try {
      ...
      toasts.addErrorToast(error?.message || 'Ha ocurrido un problema al momento de procesar tu petición');
